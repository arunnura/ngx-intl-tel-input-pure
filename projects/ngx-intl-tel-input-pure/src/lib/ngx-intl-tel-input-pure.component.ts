...
@Component({
  ...
  styleUrls: ['./assets/css/intlTelInput.scss', './ngx-intl-tel-input-pure.component.scss'],
  providers: [
    CountryCode,
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NgxIntlTelInputPureComponent),
      multi: true,
    },
    {
...
export class NgxIntlTelInputPureComponent implements OnInit, OnChanges {
  @Input() value = '';
